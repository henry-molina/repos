...
GO
DELETE FROM SCH_CENTRA_ID.COMPANIES_STRUCTURES WHERE PARENT_ID IS NOT NULL
GO
...
GO
DELETE FROM SCH_CENTRA_ID.APPLICATIONS_GROUP WHERE CODE NOT IN ('BANCS','PPRD','LOGIFLOW','RHDS','AD')
GO
